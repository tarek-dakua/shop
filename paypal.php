...
<form action="<?php echo $paypal_url;?>/cgi-bin/webscr" method="post" name="buyCredits" id="buyCredits">
    ...
    <input type="hidden" name="business" value="tarek.dakua-facilitator@gmail.com">
    ...
    <input type="hidden" name="return" value="http://localhost/shop/payment_success.php?id=<?php echo $order_id; ?>">
</form>
<script type="text/javascript">
